...
class AddEmployeePage {
  ...
  private readonly firstNameTextBox: Locator = this.page.getByRole("textbox", {
    name: "First Name",
  });
  private readonly lastNameTextBox: Locator = this.page.getByRole("textbox", {
    name: "Last Name",
  });
  private readonly middleNameTextBox: Locator = this.page.getByRole("textbox", {
    name: "Middle Name",
  });
  ...
  private readonly saveButton: Locator = this.page.getByRole("button", {
    name: "Save",
  });
